...
\begin{figure}[t]
	...
	\caption[実験 S1366 のエネルギーフラックスの水平分布]{
		...
		(\subref{S1366降水}) \(1\hmu{W/m^2}\);
		(\subref{S1366潜熱}) \(20\hmu{W/m^2}\);
...
\begin{figure}[t]
	...
	\caption[実験 S1366nc のエネルギーフラックスの水平分布]{
		...
		(\subref{S1366OLR}) \(10\hmu{W/m^2}\);
		(\subref{S1366SLR}) \(10\hmu{W/m^2}\);
		(\subref{S1366降水}) \(0.1\hmu{W/m^2}\);
		(\subref{S1366潜熱}) \(30\hmu{W/m^2}\);
		(\subref{S1366顕熱}) \(4\hmu{W/m^2}\)。
	}\label{S1366nc_heat}
\end{figure}
